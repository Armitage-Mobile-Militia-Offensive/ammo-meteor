          ...
          <div className="col-8 offset-2">
            ...
            <div className="card text-center row ">
              ...
              <form onSubmit={this.onSubmit.bind(this)}>
                <div className="input-group container-fluid col-4 offset-4 row">
                  <div className="input-group-addon container-fluid col-3">Email</div>
                  <input type="text" className="form-control container-fluid col-9" ref="email"/>
                </div>
                <br/>
                <div className="input-group col-4 offset-4 row">
                  <div className="input-group-addon col-3">Password</div>
